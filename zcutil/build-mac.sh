...
CXXFLAGS='-arch x86_64 -I/usr/local/Cellar/gcc@6/6.5.0_5/include/c++/6.5.0 '"-I${PREFIX}/include"' -fwrapv -fno-strict-aliasing -g0 -O2 -Wl,-undefined -Wl,dynamic_lookup' \
