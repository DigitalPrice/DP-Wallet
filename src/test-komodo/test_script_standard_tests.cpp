...
TEST(TestScriptStandartTests, script_standard_Malpill) {
    ...
    CScript modifiedScript;
    std::vector<unsigned char> modData;
    ...
    modifiedScript.erase(modifiedScript.begin());
    modifiedScript.insert(modifiedScript.begin(), modData.begin(), modData.end());
    ...
    modifiedScript.erase(modifiedScript.begin() + 2);
    modifiedScript.insert(modifiedScript.begin() + 2, modData.begin(), modData.end());
    vScriptPubKeys.push_back(modifiedScript);
