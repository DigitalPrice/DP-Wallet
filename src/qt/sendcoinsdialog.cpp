...
void SendCoinsDialog::setModel(WalletModel *_model) {
    ...
    if(_model && _model->getOptionsModel()) {
        ...
        connect(ui->customFee, &KomodoAmountField::valueChanged, this, &SendCoinsDialog::coinControlUpdateLabels);
        ...
        //TODO: Rather than rbf half in and half out, need to remove it all
